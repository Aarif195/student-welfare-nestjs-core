                        ...
                        {isEditing && (
                            <div className="flex gap-3 pt-4">
                                <button
                                    ...
                                    className="flex-1 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl font-bold text-[10px] sm:text-xs uppercase tracking-widest text-primary-400 hover:bg-primary-50 transition-all cursor-pointer text-center"
                                >
                                    Cancel
                                </button>
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-brand text-white py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl font-bold text-[10px] sm:text-xs uppercase tracking-widest hover:opacity-90 disabled:opacity-50 transition-all flex items-center justify-center gap-1.5 sm:gap-2 shadow-lg shadow-blue-100 cursor-pointer shrink-0"
                                >
                                    {isPending ? <Loader2 size={14} className="animate-spin shrink-0" /> : <><Save size={14} className="shrink-0" /> <span>Save Changes</span></>}
                                </button>
                            </div>
                        )}
                    </form>
